...
const OrderCard = () => {
  ...
  return (
    <Box  onClick={() => navigate(`/account/order/${5}`)} className="p-6 bg-white rounded-2xl shadow-md hover:shadow-xl border border-gray-200 transition-shadow duration-300 mb-4">
      ...
      <Grid spacing={2} container sx={{ justifyContent: "space-between" }}>
        <Grid item xs={6}>
            <div  className="flex cursor-pointer">
                ...
                src="data:image/png;base64,"
                 alt="" />
                <div className="ml-5">
                    <p className="mb-2"> AbBA aMAmman bhi jaA
        ...
        <Grid item xs={4}>
        <p className="flex items-center space-x-2 font-semibold text-sm text-green-600 mb-1">
            ...
            <p className="text-xs text-gray-600 mb-2">Your Item Has Been Delivered</p>
            <div
              
              className="flex items-center text-blue-600 hover:underline cursor-pointer"
            >
              <StarIcon sx={{ fontSize: "1.8rem" }} className="mr-2" />  
